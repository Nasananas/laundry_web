<x-layout2>
    ...
    @section('content')
        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Tambah Kas Keluar</h3>
                
                <!-- Form Tambah Kas Keluar -->
                <form action="{{ route('admin.kaskeluar.submit') }}" method="POST">
                    @csrf
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            <label for="nama_pengeluaran" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Pengeluaran</label>
                            <input type="text" name="nama_pengeluaran" id="nama_pengeluaran" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan Nama Pengeluaran" required />
                        </div>
                        <div>
