<aside class="w-64 h-[100vh] bg-[#e0e4f7] shadow-lg fixed hidden md:block z-50">
    <div class="h-full flex flex-col justify-between text-[#556bce]">
       <div>
          ...
          <nav class="mt-5">
             <a href="{{ route('account.dashboard') }}" class="flex items-center gap-x-2 py-2.5 px-4 rounded hover:bg-[#d5ddff] text-[#556bce]">
            ...
            <a href="{{ route('account.layanan') }}" class="flex items-center gap-x-2 py-2.5 px-4 rounded hover:bg-[#d5ddff] text-[#556bce]">
               <svg class="w-6 h-6 text-[#556bce]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('account.pesanan') }}" class="flex items-center gap-x-2 py-2.5 px-4 rounded hover:bg-[#d5ddff] text-[#556bce]">
            ...
            <a href="{{ route('account.history') }}" class="flex items-center gap-x-2 py-2.5 px-4 rounded hover:bg-[#d5ddff] text-[#556bce]">
               <svg class="w-6 h-6 text-[#556bce]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('account.hutang') }}" class="flex items-center gap-x-2 py-2.5 px-4 rounded hover:bg-[#d5ddff] text-[#556bce]">
               <svg class="w-6 h-6 text-[#556bce]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('account.akun') }}" class="flex items-center gap-x-2 py-2.5 px-4 rounded hover:bg-[#d5ddff] text-[#556bce]">
               <svg class="w-6 h-6 text-[#556bce]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('account.logout') }}" class="flex items-center gap-x-2 py-2.5 px-4 rounded hover:bg-[#d5ddff] text-[#556bce]">
               <svg class="w-6 h-6 text-[#556bce]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
